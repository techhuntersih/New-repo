...
function Form(){
    ...
    const ColorlibConnector = withStyles({
      ...
      const CustomStepIcon = (props) => {
        ...
        case 0: return(<Child  />);
        break;
        case 1: return(<Father nextStep={nextStep} />);
        break;
        case 2: return(<Mother nextStep={nextStep} />);
        break;
        case 3: return(<Family nextStep={nextStep} />);
        break;
        case 4: return(<HearingStatus nextStep={nextStep} />);  
          break;
...
//  };
    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
              <Stepper className="st" activeStep={activeStep} orientation="horizontal" connector={<ColorlibConnector />} >
            <Step >
                <StepLabel 
